...
def visualize_model(device, dataloaders, model, class_names, num_images=6):
    ...
    with torch.no_grad():
        for i, (inputs, labels) in enumerate(dataloaders['val']):
            ...
            #                             START OF YOUR CODE                                   #
            ####################################################################################
            # TODO: Perform feedforward operation using model,
...
def finetune(device, dataloaders, dataset_sizes, class_names):
    ...
    #                             START OF YOUR CODE                                   #
    ####################################################################################
    # TODO: Replace the last layer of model_ft with a linear layer with 2 output classes
    ...
    #                             START OF YOUR CODE                                   #
    ####################################################################################
    # TODO: Set the criterion function for multi-class classification,
    # and prepare the optimizer
...
def freeze(device, dataloaders, dataset_sizes, class_names):
    ...
    model_conv = train_model(device, dataloaders, dataset_sizes, model_conv,
                             criterion, optimizer_conv, exp_lr_scheduler, num_epochs=25)
...
def main():
    ...
    # https://drive.google.com/file/d/1pzQg8ydLM1z7UEUYq52-iFzUCB55b3wz/view?usp=sharing
